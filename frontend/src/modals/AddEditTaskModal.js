      ...
      >
        ...
        <div className="mt-8 flex flex-col space-y-1">
          ...
          <textarea
            ...
            placeholder="e.g. Got positive feedback on my skills and experience for company."
          />
        </div>
          ...
          {subtasks.map((subtask, index) => (
            <div key={index} className=" flex items-center w-full ">
              <input
                ...
                placeholder=" e.g Passed Phone Screening Round"
              />
              <img
                src={crossIcon}
                onClick={() => {
        ...
        <div className="mt-8 flex flex-col space-y-3">
          ...
          >
            {type === "edit" ? " save edit" : "Create update"}
          </button>
        </div>
      </div>
    </div>
